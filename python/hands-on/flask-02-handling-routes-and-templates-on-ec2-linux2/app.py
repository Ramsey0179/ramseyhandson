...
# we redir sct to another function
...
# ##############################
# @app.route('/<name2>') # This is inline HTML
# def greet2(name2):
#     greet_format=f"""
# <!DOCTYPE html>
# <html>
...
# Create a function named list10 which creates a list counting from 1 to 10 within 
# `list100.html` and assign to the route of ('/list100')
@app.route("/list100")
def list100():
